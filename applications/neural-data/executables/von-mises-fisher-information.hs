...
vmResponseStatistics zxss n prxk' = do
    ...
    dvg <- average <$> mapM (numericalApproximatePosteriorDivergence 1e-12 100) ppcss
    return (cvs,VonMisesInformations avfi mnfi mxfi,DivergenceStatistics dvg)
...
vmAnalyzeCoefficientOfVariation0 nsmps zxs0 _ = do
    ...
    (allcvs :: B.Vector k (CoefficientsOfVariation,VonMisesInformations,DivergenceStatistics))
